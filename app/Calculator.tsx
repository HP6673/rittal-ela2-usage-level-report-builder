          ...
          <tbody>
            {[
              ...
              [
                ...
                `${number(engineeringCurrentLevel, 2)} / ${number(report.engineeringAsIsRatio * 100, 1)}%`,
                "As Is Efficiency Level",
                `${number(productionCurrentLevel, 2)} / ${number(report.productionAsIsRatio * 100, 1)}%`,
                "",
              ],
              [
                "Target Efficiency Level",
                `${number(engineeringTargetLevel, 2)} / ${number(report.engineeringTargetRatio * 100, 1)}%`,
                "Target Efficiency Level",
                `${number(productionTargetLevel, 2)} / ${number(report.productionTargetRatio * 100, 1)}%`,
                "",
              ],
              [
                "Difference",
